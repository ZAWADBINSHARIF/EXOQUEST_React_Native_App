    ...
    const [quiz_question, set_quiz_question] = useState([
        {
            ...
            options: ["By observing the dimming of a star's light", "By observing the magnification of a distant star's light", "By measuring the Doppler shift of a star's light"],
        ...
        <View className='bg-black flex-1'>
            ...
            <View className='flex-1 h-full items-center justify-center flex-row gap-10 p-8 pt-20'>
                ...
                <View
                    ...
                    <Link
                        href={{ pathname: "/pointScreen", params: { "prevScore": (score + parseInt(prevScore as string)) } }}
                    >
